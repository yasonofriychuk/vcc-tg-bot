...
T = TypeVar("T", bound="CiscoVCSSettingBare")


@_attrs_define
class CiscoVCSSettingBare:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        is_private_licence_used = self.is_private_licence_used
        ...
        field_dict.update(
            {
                ...
                "id": id,
                "isPrivateLicenceUsed": is_private_licence_used,
            }
        )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        is_private_licence_used = d.pop("isPrivateLicenceUsed")

        need_video_recording = d.pop("needVideoRecording", UNSET)

        cisco_vcs_setting_bare = cls(
            is_microphone_on=is_microphone_on,
            is_video_on=is_video_on,
            is_waiting_room_enabled=is_waiting_room_enabled,
            id=id,
            is_private_licence_used=is_private_licence_used,
            need_video_recording=need_video_recording,
        )

        cisco_vcs_setting_bare.additional_properties = d
        return cisco_vcs_setting_bare
