...
if TYPE_CHECKING:
    from ..models.user_out_full_brief_role import UserOutFullBriefRole


T = TypeVar("T", bound="UserListOut")
...
class UserListOut:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = UserOutFullBriefRole.from_dict(data_item_data)
        ...
        user_list_out.additional_properties = d
