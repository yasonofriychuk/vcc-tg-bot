...
T = TypeVar("T", bound="MeetingUpdateValidated")


@_attrs_define
class MeetingUpdateValidated:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        meeting_update_validated.additional_properties = d
        return meeting_update_validated
