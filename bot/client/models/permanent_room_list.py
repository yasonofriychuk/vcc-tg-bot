...
T = TypeVar("T", bound="PermanentRoomList")


@_attrs_define
class PermanentRoomList:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = PermanentRoomOut.from_dict(data_item_data)
        ...
        permanent_room_list.additional_properties = d
        return permanent_room_list
