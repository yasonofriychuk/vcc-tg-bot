...
T = TypeVar("T", bound="PrivateLicenseList")


@_attrs_define
class PrivateLicenseList:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = PrivateLicenseOut.from_dict(data_item_data)
        ...
        private_license_list.additional_properties = d
        return private_license_list
