...
from ...models.body_ldap_login_auth_ldap_login_post import BodyLdapLoginAuthLdapLoginPost
...
def _get_kwargs(
    *,
    body: BodyLdapLoginAuthLdapLoginPost,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    """Ldap Login
     ...
     Авторизует пользователя через ldap аккаунт
