...
from ...models.user_update_in import UserUpdateIn
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = UserOutFull.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        user_id (int):
        body (UserUpdateIn): Промежуточная модель pydantic'а для унифицирования конфигов и
