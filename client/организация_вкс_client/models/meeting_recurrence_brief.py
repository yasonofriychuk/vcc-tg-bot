...
T = TypeVar("T", bound="MeetingRecurrenceBrief")


@_attrs_define
class MeetingRecurrenceBrief:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        meeting_recurrence_brief.additional_properties = d
        return meeting_recurrence_brief
