...
if TYPE_CHECKING:
    from ..models.building_bare import BuildingBare
    from ..models.user_brief import UserBrief


T = TypeVar("T", bound="RoomFull")
...
class RoomFull:
    ...
    Attributes:
        ...
        building (BuildingBare): Базовая модель для выдачи любого каталога
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        building = BuildingBare.from_dict(d.pop("building"))
        ...
        room_full.additional_properties = d
        return room_full
