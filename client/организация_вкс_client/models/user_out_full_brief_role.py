...
T = TypeVar("T", bound="UserOutFullBriefRole")


@_attrs_define
class UserOutFullBriefRole:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for roles_item_data in _roles:
            roles_item = CatalogElementBare.from_dict(roles_item_data)
        ...
        user_out_full_brief_role.additional_properties = d
        return user_out_full_brief_role
