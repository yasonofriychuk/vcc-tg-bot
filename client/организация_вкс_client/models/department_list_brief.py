...
T = TypeVar("T", bound="DepartmentListBrief")


@_attrs_define
class DepartmentListBrief:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = DepartmentBrief.from_dict(data_item_data)
        ...
        department_list_brief.additional_properties = d
        return department_list_brief
