...
T = TypeVar("T", bound="MunicipalAreaList")


@_attrs_define
class MunicipalAreaList:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for data_item_data in _data:
            data_item = CatalogElementBare.from_dict(data_item_data)
        ...
        municipal_area_list.additional_properties = d
        return municipal_area_list
