...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 201:
        response_201 = GroupFull.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """Create Group
     ...
     Создание новой группы ВКС

    Args:
        body (GroupCreate): Промежуточная модель pydantic'а для унифицирования конфигов и удобного
            администрирования
