...
from ...models.user_tutorial_mark import UserTutorialMark
from ...types import Response


def _get_kwargs(
    *,
    body: UserTutorialMark,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": "/users/tutorials/mark",
    }
...
def sync_detailed(
    *,
    ...
    """Mark User Tutorial
     ...
     Отметка о прохождении пользователем туториала по пользованию системой

    Args:
        body (UserTutorialMark): Промежуточная модель pydantic'а для унифицирования конфигов и
